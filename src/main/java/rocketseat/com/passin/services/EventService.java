...
import rocketseat.com.passin.dto.attendee.AttendeeResquestDTO;
...
public class EventService {
    ...
    public AttendeeIdDTO registerAttendeeOnEvent(String eventId, AttendeeResquestDTO attendeeResquestDTO){
        ...
        newAttendee.setName(attendeeResquestDTO.name());
        newAttendee.setEmail(attendeeResquestDTO.email());
